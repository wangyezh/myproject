...
function (e, t, n) {
  ...
  function i(e) {
    ...
    for (var t, n = e.split('/'), r = [
    ], i = 0; i < n.length; i++) if ('..' === (t = n[i])) {
...
function (e, t, n) {
  ...
  function a(e, i) {
    var a = t.parseMap(e);
    g[a] ? i()  : m[a] ? v[a].push(i)  : (m[a] = !0, v[a] = [
      i
    ], r._fetch(a, function () {
      g[a] = !0;
      var n = d[e];
      ...
      b = null,
      m[a] && delete m[a],
      (n = v[a]) && (delete v[a], t.forEach(n, function (e) {
        e()
      }))
    }, n.charset))
  }
  ...
  function l(e) {
    ...
    return t.filter(e.dependencies, function (e) {
      ...
      (e = c(d[e])) && (x.push(n), t.log('Found circular dependencies:', x.join(' --> '), void 0)),
      !e
    })
  }
  function c(e) {
  ...
  r.prototype._load = function (e, n) {
    function i(e) {
      (e || {
      }).status < h.READY && (e.status = h.READY),
      0 == --c && n()
    }
    ...
    s = o.length;
    if (0 === s) n();
     else for (var c = s, u = 0; u < s; u++) !function (e) {
      function t() {
  ...
  r._define = function (e, n, a) {
    ...
    if (l = e ? i(e)  : o) {
      ...
      s = r._save(l, s),
      o ? (d[o] || {
      }).status === h.FETCHING && (d[o] = s, s.realUri = o)  : b || (b = s)
    } else y = s
  },
...
function (e, t, n) {
  ...
  e.config = function (i) {
    for (var a in i) if (i.hasOwnProperty(a)) {
      ...
      } else !o || 'map' !== a && 'preload' !== a ? n[a] = s : (t.isString(s) && (s = [
        s
...
function (e, t, n) {
  ...
  t.forEach(function () {
    ...
    'debug' === t && (e._use = e.use, e._useArgs = [
    ], e.use = function () {
...
define('newweb/common/ZeroClipboard', [
  ...
  !function (e, t) {
    ...
    S = function (e) {
      ...
      ], n = 0, r = e.length; n < r; n++) w.call(e, n) && (t[n] = S(e[n]));
       else {
        t = {
        };
    ...
    E = function (e, t) {
      for (var n = {
      }, r = 0, i = t.length; r < i; r++) t[r] in e && (n[t[r]] = e[t[r]]);
      return n
    },
    j = function (e, t) {
      var n = {
    ...
    ke = function (e) {
      if (e && 'string' == typeof e.type && e) {
        ...
        s = C(i, e);
        n && r.createEvent && n.dispatchEvent && (s = [
          s.type,
          s.canBubble,
          s.cancelable,
          s.view,
          ...
          s.button,
          s.relatedTarget
        ], (t = r.createEvent('MouseEvents')).initMouseEvent && (t.initMouseEvent.apply(t, s), t._source = 'js', n.dispatchEvent(t)))
      }
    },
    Ce = function () {
  ...
  Fe = function (e) {
    ...
    if (e.trustedDomains && ('string' == typeof e.trustedDomains ? i = [
      e.trustedDomains
    ] : 'object' == typeof e.trustedDomains && 'length' in e.trustedDomains && (i = e.trustedDomains)), i && i.length) for (t = 0, n = i.length; t < n; t++) if (w.call(i, t) && i[t] && 'string' == typeof i[t]) {
  ...
  qe = function () {
    var e = function (e) {
      ...
      if ('string' == typeof e && (e = [
        e
      ]), 'object' != typeof e || !e || 'number' != typeof e.length) return i;
  ...
  st = function (e) {
    ...
    for (var t = 0; t < e.length; t++) if (w.call(e, t) && e[t] && 1 === e[t].nodeType) {
      e[t].zcClippingId ? - 1 === et[e[t].zcClippingId].indexOf(this.id) && et[e[t].zcClippingId].push(this.id)  : (e[t].zcClippingId = 'zcClippingId_' + Qe++, et[e[t].zcClippingId] = [
        this.id
    ...
    if (e && 1 === e.nodeType) {
      ...
      if ('object' == typeof t && t) {
        for (var n, r, i = [
          ...
          'out',
          'over'
        ], a = 0, o = i.length; a < o; a++) 'function' == typeof (r = t[n = 'mouse' + i[a]]) && e.removeEventListener(n, r, !1);
...
define('newweb/common/advertisement', [
'./utils'
], function (e, t) {
var n = e('./jquery-1.7'),
r = e('./utils');
...
if ('object' == typeof exports && 'undefined' != typeof module) module.exports = e();
 else if ('function' == typeof define && define.amd) define('newweb/common/clipboard.min', [
], e);
 else {
  ...
  7: [
    function (e, t, n) {
      ...
      define('newweb/common/form', [
        ...
        !function (t) {
          ...
          e.fn.ajaxSubmit = function (t, n, i, s) {
            ...
            function c(n) {
              ...
              function s(t) {
                if (!y.aborted && !L) {
                  ...
                  if (O && O.location.href !== d.iframeSrc || w) {
                    ...
                    'success' === a ? (d.success && d.success.call(d.context, D, 'success', y), k.resolve(y.responseText, 'success', y), f && e.event.trigger('ajaxSuccess', [
                      y,
                      d
                    ]))  : a && (void 0 === n && (n = y.statusText), d.error && d.error.call(d.context, y, a, n), k.reject(y, 'error', n), f && e.event.trigger('ajaxError', [
                      y,
                      d,
                      n
                    ])),
                    f && e.event.trigger('ajaxComplete', [
                      y,
                      d
                    ]),
              ...
              }, (f = d.global) && 0 == e.active++ && e.event.trigger('ajaxStart'), f && e.event.trigger('ajaxSend', [
                y,
                d
              ]), d.beforeSend && !1 === d.beforeSend.call(d.context, y, d)) return d.global && e.active--,
              k.reject(),
              k;
            ...
            (f = (f = 'string' == typeof (d = t.url || this.attr2('action')) ? e.trim(d)  : '') || window.location.href || '') && (f = (f.match(/^([^#]+)/) || [
            ]) [1]),
            t = e.extend(!0, {
              url: f,
            ...
            if (this.trigger('form-pre-serialize', [
              ...
              t,
              h
            ]), h.veto) return r('ajaxSubmit: submit vetoed via form-pre-serialize trigger'),
            this;
            ...
            if (this.trigger('form-submit-validate', [
              ...
              t,
              h
            ]), h.veto) return r('ajaxSubmit: submit vetoed via form-submit-validate trigger'),
            this;
            var x = e.param(y, m);
            g && (x = x ? x + '&' + g : g),
            ...
            if (t.success = function (e, n, r) {
              for (var i = t.context || this, a = 0, o = w.length; a < o; a++) w[a].apply(i, [
                e,
                n,
                r || p,
                p
          ...
          e.fn.formToArray = function (t, n, r) {
            ...
            if (c && (c = e.makeArray(c)), l && (t || /(Edge|Trident)\//.test(navigator.userAgent)) && (o = e(':input[form="' + l + '"]').get()).length && (c = (c || [
            ]).concat(o)), !c || !c.length) return i;
          ...
          e.fieldValue = function (t, n) {
            ...
            if ('select' === o) {
              ...
              if (s < 0) return null;
              for (var l = [
              ], c = t.options, u = 'select-one' === a, d = u ? s + 1 : c.length, f = u ? s : 0; f < d; f++) {
                var p = c[f];
        ...
        return function (e, t) {
          ...
          M = function () {
              ...
              init: function (e, n, r) {
                ...
                if ('string' == typeof e) {
                  if (!(i = '<' === e.charAt(0) && '>' === e.charAt(e.length - 1) && e.length >= 3 ? [
                    ...
                    e,
                    null
                  ] : u.exec(e)) || !i[1] && n) return !n || n.jquery ? (n || r).find(e)  : this.constructor(n).find(e);
                  if (i[1]) return n = n instanceof s ? n[0] : n,
                  l = n ? n.ownerDocument || n : O,
                  (o = m.exec(e)) ? s.isPlainObject(n) ? (e = [
                    O.createElement(o[1])
                  ], s.fn.attr.call(e, n, !0))  : e = [
                    l.createElement(o[1])
                  ] : e = ((o = s.buildFragment([i[1]], [
                    l
                  ])).cacheable ? s.clone(o.fragment)  : o.fragment).childNodes,
                  s.merge(this, e);
            ...
            s.extend = s.fn.extend = function () {
              ...
              }, c = 2), 'object' == typeof l || s.isFunction(l) || (l = {
              }), u === c && (l = this, --c); c < u; c++) if (null != (e = arguments[c])) for (n in e) r = l[n],
              l !== (i = e[n]) && (d && i && (s.isPlainObject(i) || (a = s.isArray(i))) ? (a ? (a = !1, o = r && s.isArray(r) ? r : [
              ])  : o = r && s.isPlainObject(r) ? r : {
          ...
          M.Callbacks = function (e) {
            ...
            d = function (t, n) {
              for (n = n || [
                ...
                t,
                n
              ], i = !0, s = a || 0, a = 0, o = l.length; l && s < o; s++) if (!1 === l[s].apply(t, n) && e.stopOnFalse) {
                r = !0;
                break
              }
              i = !1,
              l && (e.once ? !0 === r ? f.disable()  : l = [
              ] : c && c.length && (r = c.shift(), f.fireWith(r[0], r[1])))
            },
            f = {
              add: function () {
                if (l) {
                  ...
                  return M.Deferred(function (r) {
                    M.each({
                      ...
                      M.isFunction(i) ? l[e](function () {
                        (n = i.apply(this, arguments)) && M.isFunction(n.promise) ? n.promise().then(r.resolve, r.reject, r.notify)  : r[a + 'With'](this === l ? r : this, [
                          n
                        ])
                      })  : l[e](r[a])
                    })
              ...
              if (M.acceptData(e)) {
                ...
                if (l[c]) {
                  if (t && (r = n ? l[c] : l[c].data)) {
                    for ((a = 0, o = (t = M.isArray(t) ? t : t in r ? [
                      t
                    ] : (t = M.camelCase(t)) in r ? [
                      t
                    ] : t.split(' ')).length); a < o; a++) delete r[t[a]];
          ...
          M.fn.extend({
            data: function (e, n) {
              ...
              return 'object' == typeof e ? this.each(function () {
                M.data(this, e)
              })  : (i = e.split('.'), i[1] = i[1] ? '.' + i[1] : '', n === t ? ((s = this.triggerHandler('getData' + i[1] + '!', [
                i[0]
              ])) === t && this.length && (s = M.data(this[0], e), s = r(this[0], e, s)), s === t && i[1] ? this.data(i[0])  : s)  : this.each(function () {
                var t = M(this),
                r = [
                  i[0],
                  n
          ...
          M.extend({
            ...
            dequeue: function (e, t) {
              ...
              r && ('fx' === t && n.unshift('inprogress'), M._data(e, t + '.run', i), r.call(e, function () {
                M.dequeue(e, t)
              }, i)),
          ...
          M.fn.extend({
            ...
            toggleClass: function (e, t) {
              ...
              return M.isFunction(e) ? this.each(function (n) {
                ...
                if ('string' === n) for (var i, a = 0, o = M(this), s = t, l = e.split(W); i = l[a++]; ) o[(s = r ? s : !o.hasClass(i)) ? 'addClass' : 'removeClass'](i);
          ...
          }, M.attrHooks.tabindex.set = z.set, M.each(['width',
          'height'], function (e, t) {
          ...
          M.support.checkOn || M.each(['radio',
          'checkbox'], function () {
            M.valHooks[this] = {
              get: function (e) {
          ...
          M.event = {
            add: function (e, n, r, i, a) {
              ...
              if (3 !== e.nodeType && 8 !== e.nodeType && n && r && (o = M._data(e))) {
                for (r.handler && (r = (h = r).handler), r.guid || (r.guid = M.guid++), (l = o.events) || (o.events = l = {
                }), (s = o.handle) || (o.handle = s = function (e) {
                  return void 0 === M || e && M.event.triggered === e.type ? t : M.event.dispatch.apply(s.elem, arguments)
                }, s.elem = e), n = ae(n).split(' '), c = 0; c < n.length; c++) d = (u = J.exec(n[c]) || [
                ]) [1],
                f = (u[2] || '').split('.').sort(),
                g = M.event.special[d] || {
                },
                ...
                (m = l[d]) || ((m = l[d] = [
                ]).delegateCount = 0, g.setup && !1 !== g.setup.call(e, i, f, s) || (e.addEventListener ? e.addEventListener(d, s, !1)  : e.attachEvent && e.attachEvent('on' + d, s))),
            ...
            remove: function (e, t, n, r) {
              ...
              if (m && (u = m.events)) {
                for (t = ae(t || '').split(' '), i = 0; i < t.length; i++) {
                  ...
                  }, o = (r ? d.delegateType : d.bindType) || o, p = u[o] || [
                  ], l = p.length, s = s ? new RegExp('(^|\\.)' + s.split('.').sort().join('\\.(?:.*\\.)?') + '(\\.|$)')  : null, n || s || r || d.remove) for (c = 0; c < p.length; c++) h = p[c],
                ...
                M.isEmptyObject(u) && ((f = m.handle) && (f.elem = null), M.removeData(e, [
                  'events',
                  'handle'
                ], !0))
              }
            ...
            trigger: function (n, r, i, a) {
              if (!i || 3 !== i.nodeType && 8 !== i.nodeType) {
                ...
                if (g.indexOf('!') >= 0 && (g = g.slice(0, - 1), s = !0), g.indexOf('.') >= 0 && (g = (v = g.split('.')).shift(), v.sort()), i && !M.event.customEvent[g] || M.event.global[g]) if (n = 'object' == typeof n ? n[M.expando] ? n : new M.Event(g, n)  : new M.Event(g), n.type = g, n.isTrigger = !0, n.exclusive = s, n.namespace = v.join('.'), n.namespace_re = n.namespace ? new RegExp('(^|\\.)' + v.join('\\.(?:.*\\.)?') + '(\\.|$)')  : null, d = g.indexOf(':') < 0 ? 'on' + g : '', !a && i || n.preventDefault(), i) {
                  if (n.result = t, n.target || (n.target = i), (r = null != r ? M.makeArray(r)  : [
                  ]).unshift(n), !(f = M.event.special[g] || {
                  }).trigger || !1 !== f.trigger.apply(i, r)) {
                    if (h = [
                      [i,
                      f.bindType || g]
                    ], !a && !f.noBubble && !M.isWindow(i)) {
                      for (m = f.delegateType || g, u = null, c = i.parentNode; c; c = c.parentNode) h.push([c,
                      m]),
                      u = c;
                      u && u === i.ownerDocument && h.push([u.defaultView || u.parentWindow || e,
                      m])
                    }
                    for (l = 0; l < h.length && (c = h[l][0], n.type = h[l][1], (p = (M._data(c, 'events') || {
                    }) [n.type] && M._data(c, 'handle')) && p.apply(c, r), (p = d && c[d]) && M.acceptData(c) && p.apply(c, r), !n.isPropagationStopped()); l++);
                    return n.type = g,
            ...
            dispatch: function (n) {
              ...
              if (m[0] = n, n.delegateTarget = this, h && !n.target.disabled && (!n.button || 'click' !== n.type)) for (a = n.target; a != this; a = a.parentNode || this) {
                ...
                ], r = 0; r < h; r++) f = s[d = (u = p[r]).selector],
          ...
          function () {
            ...
            var f = function (e, t, n, i) {
              ...
              if (T.length > 1 && m.exec(e)) if (2 === T.length && h.relative[T[0]]) l = x(T[0] + T[1], t, i);
               else for (l = h.relative[T[0]] ? [
                t
              ] : f(T.shift(), t); T.length; ) e = T.shift(),
              ...
              find: {
                ...
                NAME: function (e, t) {
                  if (void 0 !== t.getElementsByName) {
                    for (var n = [
                    ], r = t.getElementsByName(e[1]), i = 0, a = r.length; i < a; i++) r[i].getAttribute('name') === e[1] && n.push(r[i]);
            ...
            function () {
              ...
              e.getElementsByTagName('*').length > 0 && (h.find.TAG = function (e, t) {
                ...
                if ('*' === e[1]) {
                  for (var r = [
                  ], i = 0; n[i]; i++) 1 === n[i].nodeType && r.push(n[i]);
                  n = r
                }
                return n
              }),
            ...
            var x = function (e, t, n) {
              for (var r, i = [
                ...
                t
              ] : t; r = h.match.PSEUDO.exec(e); ) a += r[0],
          ...
          M.fn.extend({
            ...
            add: function (e, t) {
              var n = 'string' == typeof e ? M(e, t)  : M.makeArray(e && e.nodeType ? [
                e
              ] : e),
          ...
          M.extend({
            filter: function (e, t, n) {
              return n && (e = ':not(' + e + ')'),
              1 === t.length ? M.find.matchesSelector(t[0], e) ? [
                t[0]
              ] : [
              ] : M.find.matches(e, t)
            },
            dir: function (e, n, r) {
              for (var i = [
              ], a = e[n]; a && 9 !== a.nodeType && (r === t || 1 !== a.nodeType || !M(a).is(r)); ) 1 === a.nodeType && i.push(a),
              a = a[n];
              return i
            },
          ...
          Se.th = Se.td,
          M.support.htmlSerialize || (Se._default = [
            1,
            'div<div>',
            '</div>'
          ]),
          M.fn.extend({
            ...
            remove: function (e, t) {
              for (var n, r = 0; null != (n = this[r]); r++) e && !M.filter(e, [
                n
              ]).length || (t || 1 !== n.nodeType || (M.cleanData(n.getElementsByTagName('*')), M.cleanData([n])), n.parentNode && n.parentNode.removeChild(n));
              return this
            },
            empty: function () {
            ...
            html: function (e) {
              ...
              if ('string' != typeof e || xe.test(e) || !M.support.leadingWhitespace && me.test(e) || Se[(ve.exec(e) || [
                '',
                ''
              ]) [1].toLowerCase()]) M.isFunction(e) ? this.each(function (t) {
                var n = M(this);
          ...
          M.extend({
            ...
            clean: function (e, t, n, r) {
              ...
              for (var a, o, s = [
              ], l = 0; null != (o = e[l]); l++) if ('number' == typeof o && (o += ''), o) {
          ...
          O.documentElement.currentStyle && (Ae = function (e, t) {
            ...
            r,
            i,
            a = e.currentStyle && e.currentStyle[t],
            o = e.style;
            ...
            ajax: function (e, n) {
              function r(e, n, r, o) {
                if (2 !== w) {
                  ...
                  T.statusCode(v),
                  v = t,
                  u && h.trigger('ajax' + (c ? 'Success' : 'Error'), [
                    T,
                    f,
                    c ? d : y
                  ]),
              ...
              T = {
                ...
                getResponseHeader: function (e) {
                  ...
                  if (2 === w) {
                    if (!o) for (o = {
                    }; n = Xe.exec(a); ) o[n[1].toLowerCase()] = n[2];
                    n = o[e.toLowerCase()]
                  }
                  return n === t ? null : n
                },
          ...
          M.fn.extend({
            ...
            animate: function (e, t, n, r) {
              ...
              var a = M.speed(t, n, r);
              return M.isEmptyObject(e) ? this.each(a.complete, [
                !1
              ])  : (e = M.extend({
          ...
          M.fx.prototype = {
            ...
            step: function (e) {
              ...
              if (e || i >= s.duration + this.startTime) {
                ...
                if (a) {
                  if (null == s.overflow || M.support.shrinkWrapBlocks || M.each(['',
                  'X',
                  'Y'], function (e, t) {
          ...
          'getBoundingClientRect' in O.documentElement ? M.fn.offset = function (e) {
           ...
           : M.fn.offset = function (e) {
            ...
            for (var n, r = t.offsetParent, i = t.ownerDocument, a = i.documentElement, o = i.body, s = i.defaultView, l = s ? s.getComputedStyle(t, null)  : t.currentStyle, c = t.offsetTop, u = t.offsetLeft; (t = t.parentNode) && t !== o && t !== a && (!M.support.fixedPosition || 'fixed' !== l.position); ) n = s ? s.getComputedStyle(t, null)  : t.currentStyle,
            c -= t.scrollTop,
            u -= t.scrollLeft,
          ...
          M.offset = {
            ...
            setOffset: function (e, t, n) {
              ...
              ('absolute' === r || 'fixed' === r) && M.inArray('auto', [
                l,
                c
              ]) > - 1 ? (i = (d = o.position()).top, a = d.left)  : (i = parseFloat(l) || 0, a = parseFloat(c) || 0),
        ...
        f = function (e) {
          for (var t, n = e.length, r = n + 8, i = 16 * ((r - r % 64) / 64 + 1), a = Array(i - 1), o = 0, s = 0; s < n; ) o = s % 4 * 8,
      ...
      }), define('newweb/common/requestMoreTrans', [
        './service',
        './utils',
        './md5',
        './jquery-1.7'
      ...
      }), define('newweb/common/smartResult', [
        './TranslateState',
        './log'
      ], function (e, t) {
        var n = e('./jquery-1.7'),
      ...
      }), define('newweb/common/translate', [
        './utils',
        './voice',
        './TranslateState',
        './log',
        ...
        function r(e) {
          for (var t = e.translateResult, n = [
          ], r = 0, i = M(L.state.type), a = 0; a < t.length; a++) {
            var o = t[a],
            s = [
            ];
            r += o.length;
        ...
        t.translateWeb = o,
        t.showResult = l
      }), define('newweb/common/updateResult', [
        './service',
        './utils',
        './md5',
        './jquery-1.7',
        ...
        './common/jquery-1.7',
        './common/smartResult',
        './common/requestMoreTrans',
        './common/constData',
        './common/docTrans',
        './common/form',
        './common/copy',
        './common/ZeroClipboard',
        './common/updateResult',
        ...
        function s(e) {
          ...
          d[1] ? c.hide()  : c.show(),
          '' != l.trim(s) ? (a(), f.resizeTextarea(u[0]), l('#transTarget').removeClass('input__target__text--updated'), p.translate(e, function () {
            r()
        ...
        t.init = function () {
          n('#langSelect').select({
            changedCallback: function () {
              ...
              r.state.type = e,
              '' != n('#inputOriginal').val() && n('#transMachine').trigger('click', [
                !0,
                'lan-select'
              ]),
              i.reset(),
